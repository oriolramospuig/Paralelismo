	      ...
	      double CmaxI, double scale_real, double scale_imag, int maxiter)
{
  ...
  {
    // task form exercise 3
    // var y and var x changed to do exercise 3
    //tareador_start_task("fullColumn");
	...
	equal = 1;
    	...
    	// task form exercise 2
    	//tareador_start_task("horizontalBorders");
	...
	//tareador_end_task("horizontalBorders");
    	//check vertical borders
    	// task form exercise 2
    	//tareador_start_task("verticalBorders");
	...
	//tareador_end_task("verticalBorders");
	// task form exercise 2
	//tareador_start_task("ifelse");
	...
	//tareador_end_task("ifelse");
	tareador_end_task("mandelbrot");
    }
  //tareador_end_task("fullColumn");
  }
}
